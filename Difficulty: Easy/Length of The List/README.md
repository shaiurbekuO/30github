<h2><a href="https://www.geeksforgeeks.org/problems/length-of-the-list/1?page=2&sortBy=accuracy">Length of The List</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You are given a list that contains integers. You need to return the length of the list.</span></p>
