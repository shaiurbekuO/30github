<h2><a href="https://www.geeksforgeeks.org/problems/length-of-string/1?page=1&category=Strings&sortBy=accuracy">Length of String</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You are given a string <strong>s</strong>. You need to find the <strong>length</strong> of the string and <strong>return </strong>it.</span></p>
